...
window.addEventListener('load', function () {
    ...
    element.src = "./assets/js/music.js";
    ...
    //     "MiSans",
    //     "url(" + "./assets/fonts/MiSans-Regular.woff2" + ")"
    // );
...
// new_element.setAttribute("href","./assets/css/lantern.css");
// document.body.appendChild(new_element);

// new_element=document.createElement("script");
// new_element.setAttribute("type","text/javascript");
// new_element.setAttribute("src","./assets/js/lantern.js");
// document.body.appendChild(new_element);
